sample_hmmr <- function(x, prior, trans_mat, betak, sigma2k){
#
...
###########################################################
  ...
  Z = matrix(0,n,K)
  states = matrix(0,n,1)
  mean_function= matrix(0,n,1)
  y= matrix(0,n,1)
  
  t=1;
  pz1 = prior
  z1k = rmultinom(1,1,prob=pz1) #tirage de z1 selon une multinomiale
  z1 = which(z1k == 1)
  ...
  for (t in 2:n){
    ...
    ztk = rmultinom(1,1,prob=pzt)# sample zt given zt_1
